# Система верификации юридических лиц с облачным яндекс LLM-агентом
...
> **Бот:** Здравствуйте! Я помогу вам подключиться к сервису. Для подключения укажите форму юридического лица, краткое описание экономической деятельности и подтвердите налоговое резидентство в РФ.
>
> **Пользователь:** ООО Ромашка, разработка программного обеспечения>
> **Бот:** Являетесь ли вы налоговым резидентом РФ?>
> **Пользователь:** Да, налоговый резидент РФ>
...
> **Бот:** Пройдите по ссылке для завершения подключения к сервису.

### Отказ в верификации (ИП)

> **Бот:** Здравствуйте! Я помогу вам подключиться к сервису...>
> **Пользователь:** Привет. Я работаю как ИП>
> *[Tool call: reject_user("Подключение доступно только юридическим лицам — резидентам РФ")] → Отказано*>
> **Бот:** К сожалению, вы не соответствуете требованиям подключения. Причина: Подключение доступно только юридическим лицам — резидентам РФ.

### Отказ (нерезидент)

> **Пользователь:** ООО Глобал, консалтинг, мы из Казахстана>
> *[Tool call: reject_user("Недопустимое налоговое резидентство: требуется резидент РФ")] → Отказано*
